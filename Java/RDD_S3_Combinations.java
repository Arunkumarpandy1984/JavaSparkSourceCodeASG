...
public class RDD_S3_Combinations {
	...
	public void fileToDirectory_txt() {
		...
		JavaRDD<String> lines = sc.textFile("s3a://asgcombilling/PySpark/Source/rddSource.txt");
		lines.saveAsTextFile("s3a://asgcombilling/PySpark/JavaTarget/rddTarget_FileToDirectory");
		sc.close();
	}
	...
	public void directoryToFile_csv() {
		...
		JavaRDD<String> lines1 = sc.textFile("s3a://asgcombilling/Python/Destination");
		lines1.saveAsTextFile("s3a://asgcombilling/PySpark/JavaTarget/output_DirectoryToFile.csv");
		sc.close();
	...
	public void directoryToDirectory() {
		...
		JavaRDD<String> lines2 = sc.textFile("s3a://asgcombilling/Python/Destination");
		lines2.saveAsTextFile("s3a://asgcombilling/PySpark/JavaTarget/output_DirectoryToDirectory");	
		sc.close();
